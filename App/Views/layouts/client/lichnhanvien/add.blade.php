                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group row">
                                <h5 class="text-center mb-5">Đăng ký lịch làm</h5>
                            </div>
                                ...
                                <div class="kh-all">
                                    <div>
                                        <div class="row mb10 kh-one">
                                            <label class="col-sm-3 text-end control-label col-form-label">Tài
                                                khoản</label>
                                            <div class="col-sm-6">
                                                <input style="padding-left:10px" class="form-control khung-input" type="email" name="email"
                                                       id="emailuser" placeholder="{{$_SESSION['user']['username']}}"
                                                       readonly>
                                        ...
                                        <div>
                                            <div class="row mb10 kh-one">
                                                <label class="col-sm-3 text-end control-label col-form-label">Giờ bắt
                                                    đầu</label>
                                                <div class="col-sm-6">
                                                    <input style="padding-left:10px" class="form-control khung-input" type="number"
                                                           name="timeStart"
                                                           id="timeStart">
                                        ...
                                        <div>
                                            <div class="row mb10 kh-one">
                                                <label class="col-sm-3 text-end control-label col-form-label">Giờ kết
                                                    thúc</label>
                                                <div class="col-sm-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="index.php?act=dskh"><input class="btn btn-outline-info" type="button"
                                                                            value="DANH SÁCH"></a>
                                    </div>
                                <?php
